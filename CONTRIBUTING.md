# Contributing to Fidelity's Homebrew tap

Thank you for contributing to Fidelity's Homebrew tap! This guide will help you get started and know what to expect. All contributions and project spaces are subject to our [Code of Conduct](https://github.com/fidelity/.github/blob/main/CODE_OF_CONDUCT.md).
...
Please [open an issue](https://github.com/fidelity/homebrew-tap/issues) **unless** you are making a significant security disclosure.
...
If you have other questions about this project, please [open an issue](https://github.com/fidelity/homebrew-tap/issues). To reach the Fidelity OSPO directly, please email [opensource@fmr.com](mailto:opensource@fmr.com).
